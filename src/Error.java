...
//        if(errorCode==7){
//            errorMessage.add("第"+token.line+"行："+token.getContent()+" 是非法单词/符号");
//        } else if(errorCode==28) {
//            errorMessage.add("第"+token.line+"行：标识符 "+token.getContent()+" 重复定义");
//        } else if(errorCode==29) {
//            errorMessage.add("第"+token.line+"行：常量 "+token.getContent()+" 不能作为语句的开始");
//        } else if(errorCode==30) {
//            errorMessage.add("第"+token.line+"行：标识符 "+token.getContent()+" 没有定义");
//        } else {
